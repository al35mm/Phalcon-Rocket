 ...
 * Class Mobile_Detect
 *
 * This class will detect if a users device is mobile.
 * It can be used amongst other things, for displaying
 * different content in views depending on device, without
 * loading content, using up resources then hiding with CSS.
 *
 * Search Github for Mobile Detect for more info
 *
